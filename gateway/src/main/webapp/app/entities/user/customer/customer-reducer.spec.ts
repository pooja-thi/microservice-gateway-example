...
import { ICustomer, defaultValue } from 'app/shared/model/user/customer.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_CUSTOMER),
          REQUEST(ACTION_TYPES.UPDATE_CUSTOMER),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_CUSTOMER),
          REQUEST(ACTION_TYPES.DELETE_CUSTOMER),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_CUSTOMER),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_CUSTOMER actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_CUSTOMER),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_CUSTOMER),
          payload: resolvedObject,
        },
      ];
