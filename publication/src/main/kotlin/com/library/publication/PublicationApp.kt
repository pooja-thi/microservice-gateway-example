...
import com.library.publication.config.ApplicationProperties
...
class PublicationApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes publication.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<PublicationApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(PublicationApp::class.java)
