package com.library.publication.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.library.publication.repository..*)" +
            " || within(com.library.publication.service..*)" +
            " || within(com.library.publication.web.rest..*)"
    )
