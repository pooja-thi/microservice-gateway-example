...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            ...
            createCache(cm, com.library.user.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, com.library.user.repository.UserRepository.USERS_BY_EMAIL_CACHE)
            createCache(cm, com.library.user.domain.User::class.java.name)
            createCache(cm, com.library.user.domain.Authority::class.java.name)
            createCache(cm, com.library.user.domain.User::class.java.name + ".authorities")
