...
import com.library.user.config.LOGIN_REGEX
 ...
 *
 * This class accesses the [com.library.user.domain.User] entity, and needs to fetch its collection of authorities.
 *
